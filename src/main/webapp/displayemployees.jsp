...
<tr><th>Employee ID</th><th>Name</th><th>Contact</th><th>Shift Start</th><th>Shift Start</th></tr>
<%while(rs.next()){ %>
<tr>
<td><%=rs.getString("seid")%></td>
<td><%=rs.getString("name")%></td>
<td><%=rs.getInt("contact")%></td>
<td><%=rs.getString("shiftstart")%></td>
<td><%=rs.getString("shiftend")%></td>
</tr>
<%} %>
</table>
<%st.close();con.close();%>
